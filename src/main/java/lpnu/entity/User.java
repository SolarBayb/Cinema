...
public class User {
    ...
    public User(final Long id, final String name, final String surname, final String email, final List<TicketDTO> ticketDTOList) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(id, user.id) && Objects.equals(name, user.name) && Objects.equals(surname, user.surname) && Objects.equals(email, user.email) && Objects.equals(ticketDTOList, user.ticketDTOList);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, surname, email, ticketDTOList);
    }
}